...
export function usePageStyles() {
  ...
  return {
    ...
    statusChip: (status) => {
      const map = {
        PENDIENTE: {
          bg: d ? 'rgba(245,158,11,.10)' : '#FFFBEB',
          color: d ? '#FCD34D' : '#B45309',
          border: d ? 'rgba(245,158,11,.18)' : '#FDE68A',
        },
        'EN PROCESO': {
          bg: d ? 'rgba(59,130,246,.10)' : '#EFF6FF',
          color: d ? '#93C5FD' : '#1D4ED8',
          border: d ? 'rgba(59,130,246,.18)' : '#BFDBFE',
        },
        COMPLETADA: {
          bg: d ? 'rgba(16,185,129,.10)' : '#ECFDF5',
          color: d ? '#6EE7B7' : '#047857',
          border: d ? 'rgba(16,185,129,.18)' : '#A7F3D0',
        },
        CANCELADA: {
          bg: d ? 'rgba(239,68,68,.10)' : '#FEF2F2',
          color: d ? '#FCA5A5' : '#B91C1C',
          border: d ? 'rgba(239,68,68,.18)' : '#FECACA',
        },
      }
    ...
    metricChip: (tone = 'default') => {
      const tones = {
        default: {
          bg: d ? 'rgba(255,255,255,.05)' : '#F8FAFC',
          color: d ? '#E2E8F0' : '#334155',
          border: d ? 'rgba(255,255,255,.08)' : '#E2E8F0',
        },
        warn: {
          bg: d ? 'rgba(245,158,11,.08)' : '#FFFBEB',
          color: d ? '#FCD34D' : '#B45309',
          border: d ? 'rgba(245,158,11,.15)' : '#FDE68A',
        },
        info: {
          bg: d ? 'rgba(6,182,212,.08)' : '#ECFEFF',
          color: d ? '#67E8F9' : '#0E7490',
          border: d ? 'rgba(6,182,212,.15)' : '#A5F3FC',
        },
        ok: {
          bg: d ? 'rgba(16,185,129,.08)' : '#ECFDF5',
          color: d ? '#6EE7B7' : '#047857',
          border: d ? 'rgba(16,185,129,.15)' : '#A7F3D0',
        },
        bad: {
          bg: d ? 'rgba(239,68,68,.08)' : '#FEF2F2',
          color: d ? '#FCA5A5' : '#B91C1C',
          border: d ? 'rgba(239,68,68,.15)' : '#FECACA',
        },
      }
    ...
    actionBtn: (color = 'primary') => {
      const colors = {
        primary: {
          c: d ? '#93C5FD' : '#1D4ED8',
          bg: d ? 'rgba(59,130,246,.08)' : 'rgba(29,78,216,.05)',
          border: d ? 'rgba(59,130,246,.15)' : 'rgba(29,78,216,.12)',
        },
        success: {
          c: d ? '#6EE7B7' : '#047857',
          bg: d ? 'rgba(16,185,129,.08)' : 'rgba(4,120,87,.05)',
          border: d ? 'rgba(16,185,129,.15)' : 'rgba(4,120,87,.12)',
        },
        error: {
          c: d ? '#FCA5A5' : '#B91C1C',
          bg: d ? 'rgba(239,68,68,.08)' : 'rgba(185,28,28,.05)',
          border: d ? 'rgba(239,68,68,.15)' : 'rgba(185,28,28,.12)',
        },
        warning: {
          c: d ? '#FCD34D' : '#B45309',
          bg: d ? 'rgba(245,158,11,.08)' : 'rgba(180,83,9,.05)',
          border: d ? 'rgba(245,158,11,.15)' : 'rgba(180,83,9,.12)',
        },
      }
    ...
    kpiCard: (accent = 'blue') => {
      const accents = {
        blue: {
          border: d ? 'rgba(59,130,246,.18)' : '#DBEAFE',
          left: '#3B82F6',
          bg: d ? 'rgba(59,130,246,.04)' : 'rgba(59,130,246,.02)',
          glow: 'rgba(59,130,246,.08)',
        },
        green: {
          border: d ? 'rgba(16,185,129,.18)' : '#A7F3D0',
          left: '#10B981',
          bg: d ? 'rgba(16,185,129,.04)' : 'rgba(16,185,129,.02)',
          glow: 'rgba(16,185,129,.08)',
        },
        red: {
          border: d ? 'rgba(239,68,68,.18)' : '#FEE2E2',
          left: '#EF4444',
          bg: d ? 'rgba(239,68,68,.04)' : 'rgba(239,68,68,.02)',
          glow: 'rgba(239,68,68,.08)',
        },
        amber: {
          border: d ? 'rgba(245,158,11,.18)' : '#FEF3C7',
          left: '#F59E0B',
          bg: d ? 'rgba(245,158,11,.04)' : 'rgba(245,158,11,.02)',
          glow: 'rgba(245,158,11,.08)',
        },
        purple: {
          border: d ? 'rgba(168,85,247,.18)' : '#EDE9FE',
          left: '#A855F7',
          bg: d ? 'rgba(168,85,247,.04)' : 'rgba(168,85,247,.02)',
          glow: 'rgba(168,85,247,.08)',
        },
        cyan: {
          border: d ? 'rgba(6,182,212,.18)' : '#A5F3FC',
          left: '#06B6D4',
          bg: d ? 'rgba(6,182,212,.04)' : 'rgba(6,182,212,.02)',
          glow: 'rgba(6,182,212,.08)',
        },
        slate: {
          border: d ? 'rgba(100,116,139,.22)' : '#E2E8F0',
          left: '#64748B',
          bg: d ? 'rgba(100,116,139,.05)' : 'rgba(100,116,139,.03)',
          glow: 'rgba(100,116,139,.08)',
        },
      }
