...
/* Todas las personas de las 11 lineas de FFT juntas, con la linea
...
/* Resumen por area para las cards de "Resumen por area" — FFT se
   trata como un solo bloque (suma de sus 11 lineas), el resto de
...
export function getAllAreaSummaries() {
  ...
  const entries = [
    { id: 'FFT', name: 'FFT', count: fftCount, group: colorGroupForArea('LINEA0') },
