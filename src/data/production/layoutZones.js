...
const AREA_TO_GROUP = {
  ...
  // Sorting (2026-09-08, toggle FFT/Sorting) -- mismo criterio de colores que FFT, ids propios.
  SORT_LINEA: 'PRODUCCION',
  SORT_CONVEYOR: 'PRODUCCION',
  SORT_RCY: 'SOPORTE_PRODUCCION',
  SORT_FRM: 'SOPORTE_PRODUCCION',
  SORT_KITS: 'SOPORTE_PRODUCCION',
  SORT_PNP: 'SOPORTE_PRODUCCION',
  SORT_DMR_DML: 'SOPORTE_PRODUCCION',
  SORT_DMA_DMT: 'SOPORTE_PRODUCCION',
  SORT_PATINES: 'SOPORTE',
  SORT_GERENTE: 'ADMINISTRATIVO',
  SORT_SUPERVISOR: 'ADMINISTRATIVO',
}
