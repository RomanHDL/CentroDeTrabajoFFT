...
CREATE INDEX "DowntimeRecord_areaId_createdAt_idx" ON "DowntimeRecord" USING btree ("areaId","createdAt");--> statement-breakpoint
CREATE INDEX "DowntimeRecord_reasonKey_idx" ON "DowntimeRecord" USING btree ("reasonKey");
