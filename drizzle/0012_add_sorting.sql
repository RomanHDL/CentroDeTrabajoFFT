...
CREATE UNIQUE INDEX "SortingSession_date_shift_areaId_key" ON "SortingSession" USING btree ("date","shift","areaId");--> statement-breakpoint
CREATE INDEX "SortingSession_areaId_date_idx" ON "SortingSession" USING btree ("areaId","date");--> statement-breakpoint
CREATE UNIQUE INDEX "SortingEntry_sessionId_startTime_key" ON "SortingEntry" USING btree ("sessionId","startTime");
